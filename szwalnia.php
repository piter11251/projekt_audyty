...
<head>
    ...
    <div>
        ...
        <label class="btn btn-secondary active"><input type="radio" name="podobszar" value="szwalnia" checked>Szwalnia</label>
        <label class="btn btn-secondary"><input type="radio" name="podobszar" value="krojownia">Krojownia</label>
</div>
        <br>
        <br>
        ...
        <input type="hidden" name="obszar_id" value=5 checked>
