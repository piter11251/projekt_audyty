...
<html>
<head>
    <title>Audyt Stolarnia i Modelarnia</title>
    ...
    <h1>Audyt Stolarnia i Modelarnia</h1>
    ...
    <div>
        ...
        <label class="btn btn-secondary active"><input type="radio" name="podobszar" value="Stolarnia" checked>Stolarnia</label>
        <label class="btn btn-secondary"><input type="radio" name="podboszar" value="Modelarnia">Modelarnia</label>
</div>  <br>
<br>
        ...
        <input type="hidden" name="obszar_id" value=4 checked>
