...
<head>
    ...
    <div>
        ...
        Wybierz podobszar: <br>
        <div style="width: 20%;" class="btn-group btn-group-toggle" data-toggle="buttons">
        <label class="btn btn-secondary active"><input type="radio" name="podobszar" value="Montaż" checked>Montaż</label>
        <label class="btn btn-secondary"><input type="radio" name="podobszar" value="Przygotowanie Produkcji">Przygotowanie produkcji</label>
        <label class="btn btn-secondary"><input type="radio" name="podobszar" value="Tapicernia">Tapicernia</label>
        </div>
        <br>
        <br>
        ...
        <input type="hidden" name="obszar_id" value=6 checked>
