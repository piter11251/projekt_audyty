...
<head>
    ...
    <div>
        ...
        <label class="btn btn-secondary active"><input type="radio" name="podobszar" value="Magazyn Materiałów" checked>Magazyn Materiałów</label>
        </div>
        <input type="file" name="fileToUpload">
        <br>   
        <input type="hidden" name="obszar_id" value=2 checked>
