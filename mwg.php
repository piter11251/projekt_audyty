...
<head>
    ...
    <div>
        ...
        <label class="btn btn-secondary active"><input type="radio" name="podobszar" value="MwgSits" checked>MWG Sits</label>
        <label class="btn btn-secondary"><input type="radio" name="podobszar" value="MwgIkea">MWG Ikea</label>
        </div><br>
        <br>
        ...
        <input type="hidden" name="obszar_id" value=3 checked>
        ...
        <button class="btn btn-secondary" onclick="displayData()" class="scrollTopButton">Sprawdzic dane?</button>
    </div>
